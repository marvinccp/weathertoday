    ...
    <div>
      <article className="card-info-city  cities-weather-cards">
        <div className="card-header-info">
          ...
          <img src={imageWeather} className="weather-icon" alt="weather-icon" />
        </div>
        <div className="card-main-info">
          <span className="card-main-temp">{dataCity.temp + "°"}</span>
          <div className="min-max-temp ">
            <span className="temp ">{dataCity.minTemp + "°"} | </span>
